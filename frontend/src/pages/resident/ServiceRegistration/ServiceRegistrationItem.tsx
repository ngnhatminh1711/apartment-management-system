...
const ServiceRegistrationItem = ({ data, onDelete }: Props) => {
  return (
    <div className="bg-surface-container rounded-xl p-8 shadow-sm border border-outline flex flex-col md:flex-row md:items-center justify-between gap-6 hover:shadow-md transition-all duration-300">
      ...
      {data?.status === "ACTIVE" && (
        <div className="flex items-center gap-3">
          ...
          <button className="p-3 text-on-surface-variant hover:bg-surface-variant rounded-lg transition-all">
