...
export const ROLE_OPTIONS: { value: UserRole | ""; label: string }[] = [
    ...
    { value: "ROLE_MANAGER", label: "Ban quản lý" },
    { value: "ROLE_RESIDENT", label: "Cư dân" },
];

export const ALL_ROLES: UserRole[] = ["ROLE_ADMIN", "ROLE_MANAGER", "ROLE_RESIDENT"];

export const FEE_UNITS: Record<FeeType, string> = {
    ELECTRICITY: "kWh",
    WATER: "m3",
    MANAGEMENT: "tháng",
    PARKING_MOTORBIKE: "xe/tháng",
    PARKING_CAR: "xe/tháng",
    GARBAGE: "tháng",
    INTERNET: "tháng",
    ELEVATOR: "tháng",
};
